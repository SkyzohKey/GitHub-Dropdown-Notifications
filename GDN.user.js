...
function receiveNotificationsPage(targetPage, data, textStatus, jqXHR){
	...
	$("<style>").html(""
	  ...
	  + "   padding: 8px 8px; "
	  + " } "
		+ " .notifications-dropdown > center:hover { "
		+ "   background-color: grey; "
	  + " } "
		+ " .css-truncate, .notifications .list-group-item-name a { "
										+ "   max-width: 200px !important;"				
		+ " } "
		+ " .notitifcations-dropdown-title { "
		+ "   text-align:center; background-color: red !important;"
		+ " } "
		...
		+ " .boxed-group > h3 { border-radius: 0; border-width: 1px 0 0; } "
		+ " .boxed-group-inner { border: 0; border-radius: 0; padding: 0; border-top: 1px solid #D8D8D8; border-bottom: 1px solid #D8D8D8; } "
